...
public class Tester {
	...
	static String sqlStatement1="insert into jdbc.company values(2,'Wipro','Hyderabad','CGR3',true,1506252,385,1325.11)";
	static String sqlStatement2="insert into jdbc.company values(3,'TATA','Mumbai','CGR2',true,3654211,400,1523.54)";
	static String sqlStatement3="insert into jdbc.company values(4,'TechMahindra','Chennai','CGR2',true,154211,200,1123.54)";
	static String sqlStatement4="insert into jdbc.company values(5,'Accenture','Bangalore','CGR3',true,254211,180,1223.74)";
